...
export class Migration20241113092940 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`create table "highscore" ("difficulty" varchar(255) not null, "type" varchar(255) not null, "song_id" varchar(255) null, "all_justice" boolean not null, "clear" boolean not null, "full_combo" boolean not null, "score" int not null, "rating" numeric(10,2) null, constraint "highscore_pkey" primary key ("difficulty", "type", "song_id"));`);
